    ...
    <>
      ...
      <section id="hero-section" className="grid grid-cols-1 lg:grid-cols-12 border-b border-zinc-900 min-h-[calc(100vh-5rem)] items-stretch">
        ...
        >
          ...
          {/* Short bio */}
          <motion.p variants={itemVariants} className="text-base sm:text-lg text-zinc-400 max-w-xl font-normal leading-relaxed">
            {description}
          </motion.p>
          {/* CTA Buttons */}
          <motion.div variants={itemVariants} className="flex flex-wrap gap-4 pt-2">
            <a href={ctaPrimaryUrl} className="group flex items-center gap-2 bg-white text-black hover:bg-zinc-200 px-6 py-3.5 text-xs font-mono font-semibold tracking-widest uppercase transition-all duration-300 border border-transparent">
              {ctaPrimaryText}
            ...
            <a href={ctaSecondaryUrl} className="group flex items-center gap-2 bg-transparent text-white hover:bg-zinc-950 px-6 py-3.5 text-xs font-mono font-semibold tracking-widest uppercase transition-all duration-300 border border-zinc-800 hover:border-zinc-650">
              {ctaSecondaryText}
              <ArrowDownRight className="w-4 h-4 transition-transform duration-300 group-hover:translate-x-0.5 group-hover:translate-y-0.5" />
            </a>
          </motion.div>
